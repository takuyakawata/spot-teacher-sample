...
func (gq *GradeQuery) QueryLessonPlans() *LessonPlanQuery {
	query := (&LessonPlanClient{config: gq.config}).Query()
...
func (gq *GradeQuery) WithLessonPlans(opts ...func(*LessonPlanQuery)) *GradeQuery {
	query := (&LessonPlanClient{config: gq.config}).Query()
...
func (gq *GradeQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Grade, error) {
	...
	if query := gq.withLessonPlans; query != nil {
		if err := gq.loadLessonPlans(ctx, query, nodes,
			func(n *Grade) { n.Edges.LessonPlans = []*LessonPlan{} },
			func(n *Grade, e *LessonPlan) { n.Edges.LessonPlans = append(n.Edges.LessonPlans, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (gq *GradeQuery) loadLessonPlans(ctx context.Context, query *LessonPlanQuery, nodes []*Grade, init func(*Grade), assign func(*Grade, *LessonPlan)) error {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(grade.LessonPlansTable)
		s.Join(joinT).On(s.C(lessonplan.FieldID), joinT.C(grade.LessonPlansPrimaryKey[0]))
		s.Where(sql.InValues(joinT.C(grade.LessonPlansPrimaryKey[1]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(grade.LessonPlansPrimaryKey[1]))
