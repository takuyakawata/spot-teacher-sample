...
const (
	// Label holds the string label denoting the educationcategory type in the database.
	Label = "education_category"
	...
	LessonPlansTable = "lesson_plan_education_categories"
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "education_categories"
// table and are not defined as standalone fields in the schema.
var ForeignKeys = []string{
	"lesson_schedule_education_categories",
}
...
var (
	...
	LessonPlansPrimaryKey = []string{"lesson_plan_id", "education_category_id"}
)
