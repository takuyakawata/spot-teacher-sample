//go:build tools && tools && tools && tools && tools && tools && tools && tools && tools && tools && tools && tools && tools && tools && tools && tools && tools && tools && tools
// +build tools,tools,tools,tools,tools,tools,tools,tools,tools,tools,tools,tools,tools,tools,tools,tools,tools,tools,tools
...
func init() {
	...
	// emailverificationDescCreateTime is the schema descriptor for create_time field.
	emailverificationDescCreateTime := emailverificationMixinFields0[0].Descriptor()
	// emailverification.DefaultCreateTime holds the default value on creation for the create_time field.
	emailverification.DefaultCreateTime = emailverificationDescCreateTime.Default.(func() time.Time)
	// emailverificationDescUpdateTime is the schema descriptor for update_time field.
	emailverificationDescUpdateTime := emailverificationMixinFields0[1].Descriptor()
	// emailverification.DefaultUpdateTime holds the default value on creation for the update_time field.
	emailverification.DefaultUpdateTime = emailverificationDescUpdateTime.Default.(func() time.Time)
	// emailverification.UpdateDefaultUpdateTime holds the default value on update for the update_time field.
	emailverification.UpdateDefaultUpdateTime = emailverificationDescUpdateTime.UpdateDefault.(func() time.Time)
	...
	lessonreservationDescLessonScheduleID := lessonreservationFields[1].Descriptor()
	...
	lessonreservationDescSchoolID := lessonreservationFields[2].Descriptor()
	...
	lessonreservationDescUserID := lessonreservationFields[3].Descriptor()
	...
	lessonreservationDescUpdatedAt := lessonreservationFields[11].Descriptor()
	...
	lessonreservationDescCreatedAt := lessonreservationFields[12].Descriptor()
	...
	lessonreservationDescID := lessonreservationFields[0].Descriptor()
	...
	_ = uploadfileFields
	// uploadfileDescCreateTime is the schema descriptor for create_time field.
	uploadfileDescCreateTime := uploadfileMixinFields0[0].Descriptor()
	// uploadfile.DefaultCreateTime holds the default value on creation for the create_time field.
	uploadfile.DefaultCreateTime = uploadfileDescCreateTime.Default.(func() time.Time)
	// uploadfileDescUpdateTime is the schema descriptor for update_time field.
	uploadfileDescUpdateTime := uploadfileMixinFields0[1].Descriptor()
	// uploadfile.DefaultUpdateTime holds the default value on creation for the update_time field.
	uploadfile.DefaultUpdateTime = uploadfileDescUpdateTime.Default.(func() time.Time)
	// uploadfile.UpdateDefaultUpdateTime holds the default value on update for the update_time field.
	uploadfile.UpdateDefaultUpdateTime = uploadfileDescUpdateTime.UpdateDefault.(func() time.Time)
