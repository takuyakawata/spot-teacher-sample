...
type valueObject[T any] struct{ value T }

func NewValueObject[T any](v T) ValueObject[T] { return &valueObject[T]{value: v} }

func (v *valueObject[T]) Value() T { return v.value }
