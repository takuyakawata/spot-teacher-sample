...
import (
	...
	domain "github.com/takuyakawta/spot-teacher-sample/spot-teacher/internal/user/domain"
)
...
func (m *MockTeacherRepository) Create(arg0 context.Context, arg1 *domain.Teacher) error {
	m.ctrl.T.Helper()
...
func (m *MockTeacherRepository) FindByID(arg0 context.Context, arg1 domain.TeacherID) (*domain.Teacher, error) {
	m.ctrl.T.Helper()
...
func (m *MockTeacherRepository) FindByEmail(arg0 context.Context, arg1 sharedDomain.EmailAddress) (*domain.Teacher, error) {
	m.ctrl.T.Helper()
